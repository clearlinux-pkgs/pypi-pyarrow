...
Source0  : https://files.pythonhosted.org/packages/a2/ee/a7810cb9f3d6e9238e61d312076a9859bf3668fd21c69744de9532383912/pyarrow-20.0.0.tar.gz
Summary  : Python library for Apache Arrow
Group    : Development/Tools
License  : Apache-2.0
Requires: pypi-pyarrow-python = %{version}-%{release}
Requires: pypi-pyarrow-python3 = %{version}-%{release}
BuildRequires : apache-arrow-dev
...
%prep
%setup -q -n pyarrow-20.0.0
cd %{_builddir}/pyarrow-20.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749662416
